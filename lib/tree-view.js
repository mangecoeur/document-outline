...
class TreeView extends HTMLElement {
  ...
  onItemClick(callback) {
    // TODO make this work, suspect using jquery binding will be more robust
    // $(this).find('tree-node').click(callback);
  ...
  onItemDblClick(callback) {
    // $(this).find('tree-node').dblclick(callback);
