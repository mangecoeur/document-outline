\chapter{Test text from ThinkJava by Allen Downey Al}


\section[bug]{The first bug}

\partial{This should not be a heading}
...
\subsection{Oddities and errors}
